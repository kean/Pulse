...
public extension LoggerMessageStore {
    ...
    static let model: NSManagedObjectModel = {
        ...
        do {
            ...
            requestDetails.properties = [request, response, error, metrics]
        }
        ...
        do {
            ...
            request.properties = [createdAt, session, url, host, httpMethod, errorDomain, errorCode, statusCode, requestBodyKey, responseBodyKey, details, message]
        }
