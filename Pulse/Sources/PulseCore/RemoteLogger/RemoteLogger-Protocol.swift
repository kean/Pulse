...
extension RemoteLogger {
    ...
    struct PacketNetworkMessage {
        ...
        static func encode(_ message: LoggerStore.NetworkMessage) throws -> Data {
            ...
            let strippedMessage = LoggerStore.NetworkMessage(createdAt: message.createdAt, request: message.request, response: message.response, error: message.error, requestBody: nil, responseBody: nil, metrics: message.metrics, session: message.session)
        ...
        static func decode(_ data: Data) throws -> LoggerStore.NetworkMessage {
            ...
            return LoggerStore.NetworkMessage(createdAt: message.createdAt, request: message.request, response: message.response, error: message.error, requestBody: requestBody, responseBody: responseBody, metrics: message.metrics, session: message.session)
        }
    }
