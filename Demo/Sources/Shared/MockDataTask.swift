...
public struct MockDataTask {
    public let request: URLRequest
    public let response: URLResponse
    public let responseBody: Data
    public let metrics: NetworkLogger.Metrics

    public init(request: URLRequest, response: URLResponse, responseBody: Data, metrics: NetworkLogger.Metrics) {
...
extension MockDataTask {
    public static let login = MockDataTask(
...
extension MockDataTask {
    public static let profileFailure = MockDataTask(
...
extension MockDataTask {
    public static let octocat = MockDataTask(
...
public let mockStatsFailureRequest: URLRequest = {
...
public struct MockJSON {
    public static let githubLoginResponse = """
    {
        "access-token": "a1",
        "refresh-token": "m1",
        "profile": {
    ...
    public static let allPossibleValues = """
    {
      "actors": [
        {
          "name": "Tom Cruise",
